...
public class MainClient {
     ...
     * @throws User.UserNotExistException if the username doesn't exist in database
     * @throws User.WrongPasswordException if the username is registered with another password
     */
    private static boolean login(String nickname, String password)
            throws User.UserNotExistException, User.WrongPasswordException {
     ...
     * @throws User.UserNotExistException if nickname is not a registered user
     */
    private static boolean friendship(String nickname) throws User.UserNotExistException {
     ...
     * @throws ChatRoom.ChatNotExistException if not exist a chat with this title
     */
    private static boolean addMe(String chatId) throws ChatRoom.ChatNotExistException {
        return false;
    }
    ...
    private static boolean message2friend(String nickname, String message)
            throws User.UserNotExistException, User.NotFriendsException, User.UserOfflineException {
        return false;
    }

    private static boolean message2chat(String chatName, String message)
            throws ChatRoom.ChatNotExistException, ChatRoom.AllUSersOfflineException {
        return false;
    }
