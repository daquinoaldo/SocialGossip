...
\DeclareRobustCommand{\filename}[1]{
    \begingroup
        \def\textendash{-}
        \filename@parse{#1}
        \edef\filename@misc{\detokenize\expandafter{\filename@misc}}
        \texttt{\filename@misc.\filename@ext}
    \endgroup
}
\makeatother
...
\addsrcfile{../../server/src/misc/RequestsHandler.java}
\addsrcfile{../../server/src/misc/EndpointsHandler.java}
\addsrcfile{../../server/src/misc/OnlineUsers.java}
\addsrcfile{../../server/src/misc/User.java}
